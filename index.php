        ...
        <div id="anim">
            <svg class="plane" id="plane" viewBox="0 0 219 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    ...
                    fill="#232323"></path>
                <path d="M155.737 53.7836L127.85 49.8666L155.73 41.7585L161.196 46.3583L155.737 53.7836Z" fill="white">
                </path>
                ...
                <g class="propeller">
                    <g>
                        <path id="propeller--center-empty"
